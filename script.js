...
(function(){
  ...
  // Dialogue content (lines, idle chatter, hold reactions, time-of-day
  // lines) lives in buddy-dialogue.js, loaded before this file.
  const {
    lines, idleLines, rareLine, RARE_LINE_CHANCE,
    TIME_LINE_CHANCE, getTimeLine, holdLines, HOLD_REACTIONS
  ...
  // holdLines / HOLD_REACTIONS now come from buddy-dialogue.js (destructured above)
...
(function(){
  ...
  // { src: "assets/audio/song.mp3", title: "...", artist: "...", cover: "..." }
    ...
    { src: "assets/audio/I Thought I Saw Your Face Today.mp3" },
    { src: "assets/audio/OK Overture.mp3" }
  ];
